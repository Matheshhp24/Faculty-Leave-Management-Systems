...
urlpatterns = [
    ...
    path('maternity-leave/',maternity_leave_function,name='MaternityLeave'),
    ...
    path('cancel-requests-handling/', cancel_requests_handling, name='CancelRequestsHandling'),
    ...
    path('leave-data/',admin_page , name='LeaveData'),
    ...
    path('freeze-dates/', admin_page, name='freeze_dates'),
    path('permission/', permission_view_function, name='Permission'),
    path('ch-proof-submission/', ch_proof_function, name='CHProof'),
    # Add other URL patterns as needed
    # path('cancellation_request/', cancellation_request, name='CancellationRequest'),
    path('cancel_leave/', cancel_leave, name='cancel_leave'),
